...
phen_file = open("BYxRM_PhenoData.txt")
...
genotype_file = open("BYxRM_GenoData.txt")
...
out_dict["genotypes"] = [
    [new_coding_dict[x] for x in [gens[y][n] for y in range(len(gens))[1:-1]]]
    for n in range(len(gens[0]))[1:]
]
