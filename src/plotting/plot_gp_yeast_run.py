...
target_folder = sys.argv[
    1
]  # folder containing output of G-P Atlas when run on the Yeast cross data
...
print(sc.stats.pearsonr(coef_det, herit))
print(sc.stats.linregress(coef_det, herit))
...
print(sc.stats.pearsonr(add_var, coef_det))
print(sc.stats.linregress(add_var, coef_det))
plt.plot([0, 1], [0, 1], ":k", linewidth=0.75)
plt.xticks(fontfamily="monospace")
plt.yticks(fontfamily="monospace")
